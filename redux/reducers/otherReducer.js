...
export const otherReducer = createReducer({}, (builder) => {
  builder
    ...
    .addCase("updateProductFail", (state) => {
      state.loading = false;
      state.error = action.payload;
    })
    .addCase("updateProductImageFail", (state) => {
      state.loading = false;
      state.error = action.payload;
    })
    .addCase("deleteProductImageFail", (state) => {
      state.loading = false;
      state.error = action.payload;
    })
    .addCase("deleteProductFail", (state) => {
      state.loading = false;
      state.error = action.payload;
    })
    .addCase("forgetPasswordFail", (state) => {
      state.loading = false;
      state.error = action.payload;
    })
    .addCase("resetPasswordFail", (state) => {
      state.loading = false;
      state.error = action.payload;
    });
