...
const Payment = ({ navigation, route }) => {
  ...
  // I am getting this error "StripeSdk.presentPaymentSheet got 2 arguments, expected 3"  correct this code for me
  const onlineHandler = async () => {
    try {
      ...
      const init = await stripe.initPaymentSheet({
        ...
        merchantDisplayName: "deySouravEcom",
      });
      if (init.error)
        return Toast.show({
          type: "error",
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.radioStyle}>
            ...
            <RadioButton color={colors.color7} value={"COD"} />
          </View>
          <View style={styles.radioStyle}>
            <Text style={styles.radioStyleText}>ONLINE</Text>
            <RadioButton color={colors.color7} value={"ONLINE"} />
          </View>
        </RadioButton.Group>
      </View>
      <TouchableOpacity
